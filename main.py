...
for split in range(0,1):
    ...
    train(Model_SPOT(n_classes=11),train_loader,valid_loader,test_loader,num_epochs=300,csv_name=f"result_split-{split}.csv",model_file=f"model_split-{split}.pth")
