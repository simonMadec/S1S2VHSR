...
for index,reg_ in df.iterrows():
    ...
    for split in [0,1,2,3,4]:
        for model in [f"Model_S1-S2-Spot_site-data_reunion_origin_10m_split-{split}"]: # ,"reunion2345150cm_S1-S2-Spot_site-data_reunion_origin_out150cmGSD_v2_split-0"
            for dataset in ["data_reunion_origin"]: # ,]: # "data_ToyReunion","data_ToyDordogne",,"data_dordogne_origin","data_ToyDordogne"
                ...
                with torch.no_grad():
                    ...
                    if "150cm" in model:
                        ...
                        ref = "S1"
                        outname = f"result/infmap/{idd}_Reunion_10m_split{split}"
